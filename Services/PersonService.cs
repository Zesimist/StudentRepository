...
namespace Services
{
    public class PersonService : IPersonService
    {
        ...
        public PersonResponse AddPerson(AddPersonRequest? AddPersonRequest)
        {
        ...
        public List<PersonResponse> GetSortedPersons(List<PersonResponse> allPersons, string sortBy, SortOptions sortOrder)
        {
